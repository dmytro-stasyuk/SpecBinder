...
import dev.specbinder.processor.gherkin.FeatureProcessor;
...
import dev.specbinder.processor.gherkin.utils.RecordGenerator;
...
class TestSubclassCreator implements LoggingSupport, OptionsSupport {
     ...
     * @param featureFilePathForAnnotation the path to use in the @SourceFilePath annotation
    ...
    private static void addClassAnnotations(
        ...
        classBuilder.addAnnotation(AnnotationSpec
                ...
                .addMember("value", "\"" + AnnotationProcessor.class.getName() + "\"")
        ...
        /**
         * {@link SourceFilePath} annotation
         */
        String featureFilePathForAnnotation;
