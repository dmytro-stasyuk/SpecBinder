...
public class ParameterConversionUtils {
     ...
     *
     * @param resolver the resolver to use for enum factory method invocation
     */
     ...
     *
     * @return the current factory method resolver, or {@code null} if not set
     */
     ...
     *
     * @param enumElement the enum type element to search
     * @return the single suitable factory method, or {@code null} if none or multiple found
     */
     ...
     * @return true if the method is a suitable factory method
     */
     ...
     * @param value              the string value to resolve
     * @param targetType         the enum type mirror
     * @param factoryMethodName  the name of the factory method to invoke
     * @return the enum constant name (e.g., "MONDAY"), or {@code null} if resolution fails
     */
     ...
     * @param value      the string value to convert
     * @param targetType the enum type mirror
     * @return the resolved enum constant name, or the original value if resolution fails
     */
     ...
     * with a fallback to factory method resolution.
     *
     * @param values   the values to check
     * @param enumType the enum type element
