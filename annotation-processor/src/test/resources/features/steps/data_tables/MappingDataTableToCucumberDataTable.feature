  ...
  - this requires explicit configuration via @Gherkin2JUnitOptions(dataTableParameterType = CUCUMBER_DATA_TABLE)
    ...
    Scenario: Step with DataTable and no quoted parameters
      ...
      Then the following class should be generated:
        ...
        @SourceFilePath("features/users.feature")
    ...
    Scenario: Step with DataTable and one quoted parameter
      ...
      @Generated("dev.specbinder.processor.AnnotationProcessor")
      @TestMethodOrder(MethodOrderer.OrderAnnotation.class)
      @SourceFilePath("features/Permissions.feature")
    ...
    Scenario: Step with DataTable and multiple quoted parameters
      ...
      @Generated("dev.specbinder.processor.AnnotationProcessor")
      @TestMethodOrder(MethodOrderer.OrderAnnotation.class)
      @SourceFilePath("features/Products.feature")
  ...
  Rule: Helper methods are not duplicated when present in ancestor classes with CUCUMBER_DATA_TABLE option
    ...
    Scenario: Both helper methods in ancestor class
      ...
      Then the following class should be generated:
        ...
        @Generated("dev.specbinder.processor.AnnotationProcessor")
        @TestMethodOrder(MethodOrderer.OrderAnnotation.class)
        @SourceFilePath("features/Inventory.feature")
